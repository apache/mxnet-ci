...
mock_github_obj = MockGithub()
repo = mock_github_obj.get_repo('apache/incubator-mxnet')
print(repo)
print(repo.name)
print(repo.get_commit('sha'))
pull = repo.get_pull(123)
pr_status_bot = PRStatusBot(repo="apache/incubator-mxnet", github_obj=mock_github_obj, apply_secret=False)
pr_status_bot._label_pr_based_on_status('success', pull)
